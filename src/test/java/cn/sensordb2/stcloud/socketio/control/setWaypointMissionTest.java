...
/**
 * @author: leey
 * @date: create on 2019/12/16 23:32
 * @description:
 */
public class setWaypointMissionTest {
...
//            }
            ...
            login.put("method", "user.Login").put("params",
                    new JsonObject().put("username", "firefly1_user")
            ...
            params.put("waypointList",
                    new JsonArray().add(new JsonObject().put("latitude", 2D).put("longitude", 2D).put("altitude", 5D))
                            .add(new JsonObject().put("latitude", 4D).put("longitude", 2D).put("altitude", 5D)));
            JsonObject request = new JsonObject();
            request.put("version", "1.0");
            request.put("method", "control.SetWaypointMission");
